...
{
    filename=$1
    leaks_output=$(leaks --atExit -- ./pathfinder $filename 2>&1)

    if [[ "$leaks_output" =~ "0 leaks" ]]; then
        echo "No leaks"
    else
        echo "****************************"
...
cmp_leaks_output islands
cmp_leaks_output empty
cmp_leaks_output invalid1
cmp_leaks_output invalid1-1
cmp_leaks_output invalid1-2
cmp_leaks_output invalid1-3
cmp_leaks_output invalid1-4
cmp_leaks_output invalid2-1
cmp_leaks_output invalid2-2
cmp_leaks_output invalid2-3
cmp_leaks_output invalid2-4
cmp_leaks_output invalid3
cmp_leaks_output invalid5
cmp_leaks_output invalid6
cmp_leaks_output invalid_long_num
cmp_leaks_output invalid_long_num1
cmp_leaks_output invalid-small
cmp_leaks_output path 
cmp_leaks_output weird
cmp_leaks_output weird1
cmp_leaks_output small1
cmp_leaks_output small2
cmp_leaks_output medium
cmp_leaks_output invalid7
cmp_leaks_output invalid7-1
cmp_leaks_output invalid2-5
cmp_leaks_output invalid8
cmp_leaks_output invalid8-1
cmp_leaks_output invalid8-2
